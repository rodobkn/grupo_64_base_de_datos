...
<?php
  ...
  require("../config/conexion.php");
    ...
    $query_4 = " SELECT ciudad, pais FROM Obras, Lugares_Obras, Lugares, Lugares_ciudades, Ciudades, Ciudades_contacto_paises WHERE
    ...
    Lugares_Ciudades.id_ciudad = Ciudades.id_ciudad AND Ciudades.id_ciudad=Ciudades_contacto_paises.id_ciudad AND Obras.id_obra=$id_lugar;";
	...
	$result_5 -> execute();
    $obras_y_artistas_del_lugar = $result_5 -> fetchAll();
...
<div class="container">
  ...
  <div class="card">
      <div class="card-header">
          A continuación se mostrarán todas las <b>obras</b>, con sus respectivos <b>artistas</b>, que están a su disposición en el lugar <b> <?php echo "$nombre_lugar" ?> </b>:
      </div>
      ...
      <table class="table">
          ...
          <tr>
              ...
              <th scope="col">Artista creador</th>
          ...
          <tbody>
              ...
              <?php
              foreach ($obras_y_artistas_del_lugar as $informacion) {
                ...
                $variable_nombre_artista = $informacion[4];


                echo "<tr> <td> <a href='info_obra.php?nombre_obra=$variable_nombre_obra&id=$variable_id_obra'> $variable_nombre_obra </a> </td> 
                <td>$variable_fecha_inicio</td> <td>$variable_fecha_culminacion</td> 
                <td> <a href='info_artista.php?nombre=$variable_nombre_artista'> $variable_nombre_artista </a> </td> </tr>";
