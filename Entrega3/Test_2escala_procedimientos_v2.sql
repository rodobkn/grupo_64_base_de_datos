...
SELECT *, SUM(t1.precio_1 + t2.precio_2 + t3.precio_3) as precio_total FROM dblink('test5_connexion', 'select did, cidorigen, ciddestino, horario, duracion, dprecio from destinos') AS t1(id_viaje_1 int, id_ciudad_origen_1 int, id_ciudad_destino_1 int, horario_1 time, duracion_1 int, precio_1 int),
...
GROUP BY(t1.id_viaje_1, t1.id_ciudad_origen_1, t1.id_ciudad_destino_1, t1.horario_1, t1.duracion_1, t1.precio_1, t2.id_viaje_2, t2.id_ciudad_origen_2, t2.id_ciudad_destino_2, t2.horario_2, t2.duracion_2, t2.precio_2, t3.id_viaje_3, t3.id_ciudad_origen_3, t3.id_ciudad_destino_3, t3.horario_3, t3.duracion_3, t3.precio_3)
